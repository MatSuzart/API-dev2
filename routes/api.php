...
Route::post('/user/favorite', [UserController::class, 'toggleFavotire']);
Route::get('/user/appoitments', [UserController::class, 'getAppoitments']);

Route::get('/barbers', [BarberController::class, 'list']);
Route::get('/barber{id}',[BarberController::class, 'one']);
Route::post('/barber/{id}/appoitment', [BarberController::class, 'setAppoitment']);
